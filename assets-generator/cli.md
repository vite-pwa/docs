...
PWA Assets Generator has 5 built-in presets, check out the [preset definition](https://github.com/vite-pwa/assets/generator/blob/main/preset.ts) and [types definition](https://github.com/vite-pwa/assets/generator/blob/main/types.ts):
...
You can use one of the built-in presets or just define your own, this is the [minimalPreset]() definition:
```ts
...
The PNG files names will be generated using the following function (can be found in [utils module](https://github.com/vite-pwa/assets/generator/blob/main/utils#ts)):
```ts
